        ...
        return (
            <KeyboardAwareScrollView style={styles.container}>
                ...
                <View style={styles.wrapContainer}>
                    <InputField style={{paddingHorizontal:0}} mask={"[000000000000]"} title={"ИИН"} placeholder={"Имя"}/>
                    <InputField style={{paddingHorizontal:0}} title={"Номер телефона"} placeholder={"+7 (777) 777 77 77"} keyboardType={"numeric"} mask={"+7 ([000]) [000] [00] [00]"}/>
                </View>
